...
const Payment = () => {
    return (
        <section id="payment" className="mt-20 mx-3 md:mx-10 lg:mx-16">
            <div className=" flex flex-col md:flex-row md:justify-between gap-6  mb-14">
                ...
                <p className="text-p1 md:w-1/2">Kingdom & Company 2025 is more than just an event — it's a launchpad for vision, alignment, and Kingdom-driven momentum. Choose the registration tier that best fits your journey and join a community of leaders who build with purpose.</p>
            </div>
